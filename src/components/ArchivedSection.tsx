  ...
  return (
    <div className="mt-10">
      ...
      >
        ...
        {t.archivedSection.archivedTasks}
            ...
            return (
              <div key={task._id} className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-300 mt-0.5">{t.archivedSection.subtasksCompleted(done, total)}</p>
                </div>
                <div className="flex shrink-0 gap-2">
                  ...
                  >
                    {t.archivedSection.restore}
                  </button>
                  <button
                    onClick={() => { if (confirm(t.archivedSection.deleteConfirm)) dispatch(deleteTask(task._id)) }}
